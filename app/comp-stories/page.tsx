...
const features = [
  {
    ...
    icon: ChartBarIcon,
    list: ["Customer Segmentation for underwriting", "Customer Lifetime Value", "Loyalty Program Management", "Churn Management", "Personalized services Eg. Location-based services", "Customer Relationship Management"],
  },
  {
    ...
    list: ["Real-time Financial Reporting & Financial Statements Analysis", "Channel & Sales Performance Analysis", "Branch Transaction Analysis", "Expense Management", "Payment Analytics"],
  },
  {
    ...
    icon: ArrowPathIcon,
    list: ["Fraud Detection", "Loss Forecasting", "KYC Analysis", "Anti-Money Laundering (AML) Analysis", "Credit Risk and Exposure Analysis", "Incident Management & Claims Analysis"],
  },
  {
    ...
    list: ["Advanced Text Mining", "Attribute Analysis", "BASEL III compliance", "Data extraction with Rest API for reporting and auditing"],
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            challenges posed by the economic uncertainty, tight regulations, and
            the changing investor demographics and expectations. In this journey
            of transformation, developing capabilities with data and analytics
            to optimize operations to stay profitable, relevant, and sustainable
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-16">
                ...
                {feature.list.map((item) => (
                  <dd key={item} className="flex mt-2 text-base leading-7 text-gray-600 gap-6">
                    <span>-</span> {item}
                  </dd>
                ))}
              </div>
